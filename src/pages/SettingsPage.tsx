  ...
  return (
    <div className="page-container narrow-page-container">
      ...
      <section className="settings-section">
        <div className="settings-section-heading"><div className="settings-section-icon"><Palette size={18} /></div><div><h2>外觀與數值</h2></div></div>
      ...
      <section className="settings-section">
        <div className="settings-section-heading"><div className="settings-section-icon warning-icon"><ShieldCheck size={18} /></div><div><h2>質押風控門檻</h2></div></div>
        <div className="settings-card card">
      ...
      <section className="settings-section">
        <div className="settings-section-heading"><div className="settings-section-icon"><Database size={18} /></div><div><h2>本機資料</h2></div></div>
        <div className="settings-card card">
       ...
       <footer className="settings-footer"><span className="footer-check"><Check size={14} />本機優先</span><span>Asset Leverage Cashflow · V1.7.4</span></footer>
    </div>
  )
}
